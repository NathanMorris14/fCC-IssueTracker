    ...
    suite("3 Get request Tests", function () {
      ...
      test("View issues on a project with one filter: GET request to /api/issues/{project}", function (done) {
        chai
          ...
          .get("/api/issues/test-data-abc123")
          .query({
            _id: "65610efacb7f2d147df016c8",
          })
          .end(function (err, res) {
            assert.equal(res.status, 200);
            assert.deepEqual(res.body[0], {
              "issue_title": "fix motherboard",
              "issue_text": "1231231341354",
              "created_on": "2023-11-24T21:00:42.420Z",
              "updated_on": "2023-11-24T21:00:42.420Z",
              "created_by": "Nathan",
              "assigned_to": "",
              "open": true,
              "status_text": "",
        ...
        chai
          ...
          .end(function (err, res) {
            ...
            assert.deepEqual(res.body[0], {
              "issue_title": "Hey",
              "issue_text": "testing",
              "created_on": "2023-11-24T21:16:00.659Z",
              "updated_on": "2023-11-24T21:16:00.659Z",
              "created_by": "Nathan",
              "assigned_to": "",
              "open": true,
              "status_text": "",
              "_id": "65611290a8149ee7ec25615a",
            });
    ...
    suite("5 Put request Tests", function () {
      ...
      test("Update one field on an issue: PUT request to /api/issues/test-data-put", function (done) {
        chai
          ...
          .send({
            _id: "65611346a8149ee7ec256164",
            issue_title: "different",
          })
          .end(function (err, res) {
            assert.equal(res.status, 200);
            assert.equal(res.body.result, "successfully updated");
            assert.equal(res.body._id, "65611346a8149ee7ec256164");
    ...
    suite("3 DELETE request Tests", function () {
      ...
      test("Delete an issue with an invalid _id: DELETE request to /api/issues/{project}", function (done) {
        chai
          ...
          .delete("/api/issues/projects")
          .send({
            _id: "65611346a8149ee7ec256164invalid",
          })
          .end(function (err, res) {
            assert.equal(res.status, 200);
